...
namespace Baaziche_PCClient
{
    public partial class MainForm : Form
    {
        ...
        private void CreateEntryButton_Click(object sender, EventArgs e)
        {
            ...
            this.AllUsersPhoneBook.Open("VPNPhonebook");
            var t = RasDevice.GetDevices();
            ...
            RasEntry entry = RasEntry.CreateVpnEntry(EntryName, "198.204.224.2", RasVpnStrategy.Default,
                t[5]);
